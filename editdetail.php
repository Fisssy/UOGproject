...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin Edit Order Information</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="editdetail.php" class="breadcrumbs__item-link">Edit Order Information</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
       ...
       print "<div style=\"text-align: center;\"><p><a href=viewdetail.php>View Order Information</a></p></div>";
        ...
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>Edit Order Information</p></h3></div>";
        print "<hr/>";
?>
<div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div>
<form action="editdetail1.php" method="post">
