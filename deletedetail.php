...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin Delete Order Information</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="deletedetail.php" class="breadcrumbs__item-link">Delete Order Information</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
       ...
       print "<div style=\"text-align: center;\"><p><a href=viewdetail.php>View Order Information</a></p></div>";
        ...
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>Delete Order Information</p></h3></div>";
        print "<hr/>";
?>
<div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div>
<form action="deletedetail1.php" method="post">
                        <div class="form-group">
                           <h4><b><center>Please enter the ID you want to delete</center></h4></b>
                           <br>
                           </div>
                           <div class="form-group">
