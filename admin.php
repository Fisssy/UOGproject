...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin Page</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="admin.php" class="breadcrumbs__item-link">Admin Page</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        <h4>
            <center><li><a href="viewcomment.php">Comments</a></center>
                <br></li>
            <center><li><a href="viewuser.php">User Information</a></center><br></li>
            <center><li><a href="viewdetail.php">Order Information</a></center><br></li>
        </h4>
