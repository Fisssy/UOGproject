...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin Delete Comments</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="deletecomment.php" class="breadcrumbs__item-link">Delete Comments</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        <?php
        print "<div style=\"text-align: center;\"><p><a href=viewcomment.php>View Comments</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><a href=addcomment.php>Add New Comment</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><a href=editcomment.php>Edit Comments</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><a href=deletecomment.php>Delete Comments</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>Delete Comment</p></h3></div>";
        print "<hr/>";
?>
<div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div>
<form action="deletecomment1.php" method="post">
