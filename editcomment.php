...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin Edit Comments</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="editcomment.php" class="breadcrumbs__item-link">View Comments</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        ...
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>Edit Comment</p></h3></div>";
        print "<hr/>";
?>
<div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div>
<form action="editcomment1.php" method="post">
