...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin View Comments</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="viewcomment.php" class="breadcrumbs__item-link">View Comments</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        ...
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>View Comments</p></h3></div>";
        print "<hr/>";
        ...
        if ($result) {
            ...
            print '<th>Id</th><th>Name</th><th>Email</th><th>Comment</th>';
