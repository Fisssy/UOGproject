...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin View Order Information</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="viewdetail.php" class="breadcrumbs__item-link">View Order Information</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        <?php
        print "<div style=\"text-align: center;\"><p><a href=viewdetail.php>View Order Information</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><a href=adddetail.php>Add New Order</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><a href=editdetail.php>Edit Order Information</a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><a href=deletedetail.php>Delete Order </a></p></div>";
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>Add New Order </p></h3></div>";
        print "<hr/>";
?>

<form action="adddetail1.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="inputpickuplocation">Pick Up Location</label>
                            <input name="pickuplocation"  class="form-control" id="inputpickuplocation" placeholder="Pick up location">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="time" type="time"class="form-control" id="inputTime" placeholder="Time">
                        </div>
                        <div class="form-group">
                            <label for="inputCar">Car</label>
                            <input name="car" class="form-control" id="inputCar" placeholder="Type the car you want to take">
                        </div>
