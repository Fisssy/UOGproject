...
<main id="page-content">
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs__title">Admin Delete Users</div>
                    <div class="breadcrumbs__items">
                        <div class="breadcrumbs__wrap">
                            <div class="breadcrumbs__item">
                                <a href="index.html" class="breadcrumbs__item-link">Home</a> <span>/</span> <a
                                        href="deleteuser.php" class="breadcrumbs__item-link">Delete User Information</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        ...
        print "<br>";
        print "<div style=\"text-align: center;\"><p><h3>Delete User Information </p></h3></div>";
        print "<hr/>";
?>
<div class="row">
